...
stdenv.mkDerivation rec {
  pname = "mujoco";
  version = "2.1.0"; #2.3.0 is avaiable but doesn't play nice with mujoco-py

  src = fetchFromGitHub {
    owner = "deepmind";
    repo = pname;
    rev = version;
    hash = "sha256-God52+nksVlljgQjf6LFJtF/WX4pvchEV0BQ7/Uux4w=";
  };
  ...
  installPhase = ''
    make install
    cp $out/include/mujoco/* $out/include
  '';
